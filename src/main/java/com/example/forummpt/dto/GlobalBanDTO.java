...
public class GlobalBanDTO {
    ...
    public GlobalBanDTO(GlobalBanList globalBanList) {
        this.id = globalBanList.getId();
        this.loginBan = globalBanList.isLoginBan();
        this.writeBan = globalBanList.isWriteBan();
        this.banStartDate = globalBanList.getBanStartDate();
        this.banExpireDate = globalBanList.getBanExpireDate();
        this.userId = globalBanList.getBannedUser().getId();
    }
